...
def cn_name(
    ...
    replaced with descriptive labels. Generated labels are sanitized for safe path
    handling on Windows, macOS, and Linux. The original ID→label mapping is preserved
    in ``adata.uns["cn"]["label_map"]``.

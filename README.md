...
<p align="center">
  <img src="https://raw.githubusercontent.com/jsonmad/QXYCell/main/assets/qxycell-icon.png" alt="QXYCell icon" width="180">
</p>
...
QXYCell is not yet published on PyPI. Clone the repository and create the
...
The editable installation includes all required Python dependencies. Once an
official PyPI release is available, this section will be updated with the
corresponding `pip install` command.

...
def test_generate_threshold_table_writes_fresh_timestamped_table_from_json(tmp_path):
    ...
    assert first != second
    assert first.parent == project_dir.parent / "thresholds"
    assert second.parent == project_dir.parent / "thresholds"
...
def test_generate_threshold_table_uses_classifier_filename_for_marker_name(tmp_path):
    ...
    assert table_path.parent == project_dir.parent / "thresholds"
